...
function show_help() {
    ...
    printf "\n -m,   --mailbox                  : Execute a backup of an account, but only the mailbox."
    ...
    printf "\n -l,   --ldap                     : Execute a backup of an account, but only the ldap entry."
    ...
    printf "\n -m,   --mailbox                  : Execute a restore of an account,  but only the mailbox."
    ...
    printf "\n -l,   --ldap                     : Execute a restore of an account, but only the ldap entry."
